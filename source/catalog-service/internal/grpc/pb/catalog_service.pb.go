...
// 	protoc        v4.25.7
// source: proto/catalog_service.proto
...
const file_proto_catalog_service_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/catalog_service.proto\x12\aproduct\x1a\x1fgoogle/protobuf/timestamp.proto\"\x17\n" +
	"\x15GetAllProductsRequest\"F\n" +
	"\x16GetAllProductsResponse\x12,\n" +
	"\bproducts\x18\x01 \x03(\v2\x10.product.ProductR\bproducts\"\xd1\x03\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\n" +
	"updated_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2c\n" +
	"\x0eProductService\x12Q\n" +
	"\x0eGetAllProducts\x12\x1e.product.GetAllProductsRequest\x1a\x1f.product.GetAllProductsResponseB\x05Z\x03pb/b\x06proto3"
...
var file_proto_catalog_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_catalog_service_proto_goTypes = []any{
	(*GetAllProductsRequest)(nil),  // 0: product.GetAllProductsRequest
	(*GetAllProductsResponse)(nil), // 1: product.GetAllProductsResponse
	(*Product)(nil),                // 2: product.Product
	(*timestamppb.Timestamp)(nil),  // 3: google.protobuf.Timestamp
}
var file_proto_catalog_service_proto_depIdxs = []int32{
	2, // 0: product.GetAllProductsResponse.products:type_name -> product.Product
	...
	0, // 3: product.ProductService.GetAllProducts:input_type -> product.GetAllProductsRequest
	1, // 4: product.ProductService.GetAllProducts:output_type -> product.GetAllProductsResponse
