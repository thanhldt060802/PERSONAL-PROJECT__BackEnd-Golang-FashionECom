...
type GetUsersRequest struct {
	...
	SortBy string `query:"sort_by" default:"created_at:asc" example:"full_name,id:desc" doc:"Sort by one or more fields separated by commas. For example: sort_by=full_name,id:desc will sort by full_name in ascending order, then by id in descending order."`
}
...
type GetUserByUsernameRequest struct {
	Username string `path:"username" required:"true" doc:"Username of user."`
}

type GetUserByEmailRequest struct {
	Email string `path:"email" required:"true" doc:"Email of user."`
}
...
type KillUserTokenRequest struct {
	Token string `path:"token" required:"true" doc:"Token of logged in user."`
}
...
// type LogoutUserAccountRequest struct {}
...
type GetUsersWithElasticsearchRequest struct {
	...
	CreatedAtGTE string `query:"created_at_gte" example:"2024-01-15T00:00:00" doc:"Filter by created_at greater than or equal, with format is YYYY-MM-ddTHH:mm:ssZ."`
	CreatedAtLTE string `query:"created_at_lte" example:"2024-02-05T23:59:59" doc:"Filter by created_at less than or equal, with format is YYYY-MM-ddTHH:mm:ssZ."`
}

type StatisticsNumberOfUsersCreatedRequest struct {
	CreatedAtGTE string `query:"created_at_gte" example:"2024-01-15T00:00:00" doc:"Filter by created_at greater than or equal, with format is YYYY-MM-ddTHH:mm:ssZ."`
	CreatedAtLTE string `query:"created_at_lte" example:"2024-02-05T23:59:59" doc:"Filter by created_at less than or equal, with format is YYYY-MM-ddTHH:mm:ssZ."`
	TimeInterval string `query:"time_interval" default:"day" enum:"hour,day,week" doc:"Statistics by time interval. Available values: hour,day,month"`
}
